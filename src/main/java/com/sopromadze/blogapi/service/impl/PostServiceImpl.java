...
public class PostServiceImpl implements PostService {
	...
	public PostResponse addPost(PostRequest postRequest, UserPrincipal currentUser) {
		...
		if (!categoryRepository.existsById(postRequest.getCategoryId())) {
			ApiResponse apiResponse = new ApiResponse(Boolean.FALSE, "Category should be created before creating a post");
